...
const commands = [
  ...
  // Use column view in all finder windows by default Four-letter codes for the other view modes: `icnv`, `clmv`, `Flwv`, `Nlsv`
  ...
  // Disable spotlight keyboard shortcut, as I prefer Alfred as alternative
